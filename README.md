...
```bash
$ curl -O https://raw.githubusercontent.com/ech0wav3/fabric-home-assistant/master/hass_rpi_installer.sh && sudo chown pi:pi hass_rpi_installer.sh && bash hass_rpi_installer.sh
```
